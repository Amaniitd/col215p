...
architecture STRUCTURE of BRAM is
  ...
  signal BRAM_PORTA_1_ADDR : STD_LOGIC_VECTOR ( 2 downto 0 );
...
begin
  BRAM_PORTA_1_ADDR(2 downto 0) <= BRAM_PORTA_addr(2 downto 0);
...
blk_mem_gen_0: component BRAM_blk_mem_gen_0_0
     port map (
      addra(2 downto 0) => BRAM_PORTA_1_ADDR(2 downto 0),
